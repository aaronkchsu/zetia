...
var Obstacle = exports.Obstacle = function (_Character) {
  _inherits(Obstacle, _Character);

  function Obstacle(_ref2) {
    var x = _ref2.x,
        y = _ref2.y,
        width = _ref2.width,
        height = _ref2.height,
    ...
    var _this2 = _possibleConstructorReturn(this, (Obstacle.__proto__ || Object.getPrototypeOf(Obstacle)).call(this, { width: width, height: height, x: x, y: y, speed: speed }));

    _this2.draw = function (gameCtx) {
      console.log("DRAW CALLED", _this2.x, _this2.y, _this2.width, _this2.height);
      var ctx = gameCtx;
      ctx.fillStyle = "#000";
...
var PandoGame = function (_React$Component) {
  _inherits(PandoGame, _React$Component);

  function PandoGame(props) {
    _classCallCheck(this, PandoGame);
    ...
    _this.startGame = function () {
      ...
      console.log(_this.mainCharacter.x);
      console.log(_this.mainCharacter.y);
      console.log(_this.mainCharacter.width);
      console.log(_this.mainCharacter.height);
...
},{"react":"node_modules/react/index.js","react-dom":"node_modules/react-dom/index.js","./game.js":"client/game.js"}],"client/index.js":[function(require,module,exports) {
"use strict";
...
},{}]},{},["../../.nvm/versions/node/v6.9.5/lib/node_modules/parcel-bundler/lib/builtins/hmr-runtime.js","client/index.js"], null)
//# sourceMappingURL=/client.ef7838a4.map